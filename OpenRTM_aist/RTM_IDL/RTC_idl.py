# Python stubs generated by omniidl from /home/openrtm/svn/OpenRTM-aist-Python/OpenRTM_aist/RTM_IDL/RTC.idl
...
#
__name__ = "RTC"
_0_RTC = omniORB.openModule("RTC", r"/home/openrtm/svn/OpenRTM-aist-Python/OpenRTM_aist/RTM_IDL/RTC.idl")
_0_RTC__POA = omniORB.openModule("RTC__POA", r"/home/openrtm/svn/OpenRTM-aist-Python/OpenRTM_aist/RTM_IDL/RTC.idl")
...
class _objref_ComponentAction (CORBA.Object):
    ...
    __methods__ = ["on_initialize", "on_finalize", "on_startup", "on_shutdown", "on_activated", "on_deactivated", "on_aborting", "on_error", "on_reset"] + CORBA.Object.__methods__
...
class _objref_LightweightRTObject (_0_RTC._objref_ComponentAction):
    ...
    def attach_context(self, *args):
        return _omnipy.invoke(self, "attach_context", _0_RTC.LightweightRTObject._d_attach_context, args)

    def detach_context(self, *args):
        return _omnipy.invoke(self, "detach_context", _0_RTC.LightweightRTObject._d_detach_context, args)
    ...
    def get_owned_contexts(self, *args):
        return _omnipy.invoke(self, "get_owned_contexts", _0_RTC.LightweightRTObject._d_get_owned_contexts, args)

    def get_participating_contexts(self, *args):
        return _omnipy.invoke(self, "get_participating_contexts", _0_RTC.LightweightRTObject._d_get_participating_contexts, args)

    def get_context_handle(self, *args):
        return _omnipy.invoke(self, "get_context_handle", _0_RTC.LightweightRTObject._d_get_context_handle, args)

    __methods__ = ["initialize", "finalize", "is_alive", "exit", "attach_context", "detach_context", "get_context", "get_owned_contexts", "get_participating_contexts", "get_context_handle"] + _0_RTC._objref_ComponentAction.__methods__
...
class _objref_ExecutionContext (CORBA.Object):
    ...
    def add_component(self, *args):
        return _omnipy.invoke(self, "add_component", _0_RTC.ExecutionContext._d_add_component, args)

    def remove_component(self, *args):
        return _omnipy.invoke(self, "remove_component", _0_RTC.ExecutionContext._d_remove_component, args)
    ...
    __methods__ = ["is_running", "start", "stop", "get_rate", "set_rate", "add_component", "remove_component", "activate_component", "deactivate_component", "reset_component", "get_component_state", "get_kind"] + CORBA.Object.__methods__
...
class _objref_DataFlowComponent (_0_RTC._objref_LightweightRTObject, _0_RTC._objref_DataFlowComponentAction):
    ...
    __methods__ = [] + _0_RTC._objref_LightweightRTObject.__methods__ + _0_RTC._objref_DataFlowComponentAction.__methods__
...
class _objref_Fsm (_0_RTC._objref_LightweightRTObject):
    ...
    __methods__ = [] + _0_RTC._objref_LightweightRTObject.__methods__
...
class _objref_FsmParticipant (_0_RTC._objref_LightweightRTObject, _0_RTC._objref_FsmParticipantAction):
    ...
    __methods__ = [] + _0_RTC._objref_LightweightRTObject.__methods__ + _0_RTC._objref_FsmParticipantAction.__methods__
...
class _objref_MultiModeObject (_0_RTC._objref_LightweightRTObject, _0_RTC._objref_ModeCapable, _0_RTC._objref_MultiModeComponentAction):
    ...
    __methods__ = [] + _0_RTC._objref_LightweightRTObject.__methods__ + _0_RTC._objref_ModeCapable.__methods__ + _0_RTC._objref_MultiModeComponentAction.__methods__
...
class _objref_FsmObject (CORBA.Object):
    ...
    def send_stimulus(self, *args):
        return _omnipy.invoke(self, "send_stimulus", _0_RTC.FsmObject._d_send_stimulus, args)

    __methods__ = ["send_stimulus"] + CORBA.Object.__methods__
...
class _objref_FsmService (_0_SDOPackage._objref_SDOService):
    ...
    __methods__ = ["get_fsm_profile", "set_fsm_profile"] + _0_SDOPackage._objref_SDOService.__methods__
...
class _objref_PortService (_0_SDOPackage._objref_SDOService):
    ...
    def get_connector_profiles(self, *args):
        return _omnipy.invoke(self, "get_connector_profiles", _0_RTC.PortService._d_get_connector_profiles, args)

    def get_connector_profile(self, *args):
        return _omnipy.invoke(self, "get_connector_profile", _0_RTC.PortService._d_get_connector_profile, args)

    def connect(self, *args):
        return _omnipy.invoke(self, "connect", _0_RTC.PortService._d_connect, args)

    def disconnect(self, *args):
        return _omnipy.invoke(self, "disconnect", _0_RTC.PortService._d_disconnect, args)

    def disconnect_all(self, *args):
        return _omnipy.invoke(self, "disconnect_all", _0_RTC.PortService._d_disconnect_all, args)

    def notify_connect(self, *args):
        return _omnipy.invoke(self, "notify_connect", _0_RTC.PortService._d_notify_connect, args)

    def notify_disconnect(self, *args):
        return _omnipy.invoke(self, "notify_disconnect", _0_RTC.PortService._d_notify_disconnect, args)

    __methods__ = ["get_port_profile", "get_connector_profiles", "get_connector_profile", "connect", "disconnect", "disconnect_all", "notify_connect", "notify_disconnect"] + _0_SDOPackage._objref_SDOService.__methods__
...
class _objref_RTObject (_0_RTC._objref_LightweightRTObject, _0_SDOPackage._objref_SDO):
    ...
    __methods__ = ["get_component_profile", "get_ports"] + _0_RTC._objref_LightweightRTObject.__methods__ + _0_SDOPackage._objref_SDO.__methods__
